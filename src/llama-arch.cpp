...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_NEXTN_MAIN_PROJ,                        "blk.%d.nextn.main_proj" },
    { LLM_TENSOR_NEXTN_MAIN_NORM,                        "blk.%d.nextn.main_norm" },
    { LLM_TENSOR_NEXTN_HEAD_NORM,                        "nextn.head_norm" },
    { LLM_TENSOR_NEXTN_HC_HEAD_FN,                       "nextn.hc_head_fn" },
    { LLM_TENSOR_NEXTN_HC_HEAD_BASE,                     "nextn.hc_head_base" },
    { LLM_TENSOR_NEXTN_HC_HEAD_SCALE,                    "nextn.hc_head_scale" },
    { LLM_TENSOR_NEXTN_MARKOV_W1,                        "nextn.markov_w1" },
    { LLM_TENSOR_NEXTN_MARKOV_W2,                        "nextn.markov_w2" },
    { LLM_TENSOR_NEXTN_CONF_HEAD,                        "nextn.conf_head" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    // DSpark (DeepSeek-V4-Flash-0731 drafter) tensors
    {LLM_TENSOR_NEXTN_MAIN_PROJ,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_NEXTN_MAIN_NORM,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_NEXTN_HEAD_NORM,            {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL}},
    ...
    {LLM_TENSOR_NEXTN_MARKOV_W1,            {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_GET_ROWS}},
    {LLM_TENSOR_NEXTN_MARKOV_W2,            {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_NEXTN_CONF_HEAD,            {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    // Nemotron 3 Super
