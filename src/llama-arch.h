...
enum llm_tensor {
    ...
    LLM_TENSOR_NEXTN_MAIN_PROJ,
    LLM_TENSOR_NEXTN_MAIN_NORM,
    LLM_TENSOR_NEXTN_HEAD_NORM,
    LLM_TENSOR_NEXTN_HC_HEAD_FN,
    LLM_TENSOR_NEXTN_HC_HEAD_BASE,
    LLM_TENSOR_NEXTN_HC_HEAD_SCALE,
    LLM_TENSOR_NEXTN_MARKOV_W1,
    LLM_TENSOR_NEXTN_MARKOV_W2,
    LLM_TENSOR_NEXTN_CONF_HEAD,
